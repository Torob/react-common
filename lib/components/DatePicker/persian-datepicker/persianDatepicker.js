...
/* eslint-disable */
var _cell, _ch, _com, _cw, _days, _disday, _dt, _end, _endDate, _fontSize, _footer, _fri, _goToday, _head, _monthYear, _next, _prev, _row, _selday, _start, _startDate, _today, a, arr, b, c, d, d0, dows, firstYear, i, jd, jdf, jQuery, lastYear, lisHeight, m, m0, months, nextMonth, nums, prevMonth, r, res, strnum, wd, wds, y, y0;
/*!
...
(function () {
  ...
  var persianDate = function () {
    ...
    persianDate.prototype = {
      ...
      parse: function parse(s) {
        ...
        r.year = parseInt(y), r.month = parseInt(m), r.date = parseInt(d), r.day = jdf.getWeekday(jdf.getJulianDayFromPersian(r)), r.gDate = jdf.getGCalendarDate(jdf.getJulianDayFromPersian(r), "jgmonth");
        return r;
      },
  ...
  var jDateFunctions = function () {
    ...
    jDateFunctions.prototype = {
      ...
      getPCalendarDate: function getPCalendarDate(jd) {
        var y = 0;
        var m = 0;
        var day = 0.0;
        ...
        var r = new persianDate();
        r.year = y, r.month = m, r.date = day, r.day = this.getWeekday(this.getJulianDayFromPersian(r)), r.gDate = new Date();
        return r;
      },
      getGCalendarDate: function getGCalendarDate(jd, dateformat) {
        var y = 0;
        var m = 0;
        var day = 0.0;
      ...
      getJulianDay: function getJulianDay(d, jgGOrJ) {
        ...
        if (d0 < 1 || (m0 == 1 || m0 == 3 || m0 == 5 || m0 == 7 || m0 == 8 || m0 == 10 || m0 == 12) && d0 > 31 || (m0 == 4 || m0 == 6 || m0 == 9 || m0 == 11) && d0 > 30) {//try {
          //    console.log("Id 646");
          //} catch (e) { }
        }
      ...
      getJulianDayFromPersian: function getJulianDayFromPersian(pd) {
      ...
      getWeekday: function getWeekday(jd) {
        wds = [1, 2, 3, 4, 5, 6, 0];
        wd = Math.floor((jd + 1.5) % 7.0);
        return wds[wd];
      },
      getLastDayOfPersianMonth: function getLastDayOfPersianMonth(pd) {
  ...
  window.jDateFunctions = jDateFunctions;
